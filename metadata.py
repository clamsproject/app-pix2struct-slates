...
def appmetadata() -> AppMetadata:
    ...
    metadata = AppMetadata(
        ...
        identifier="pix2struct-slates",  # should be a single string without whitespaces. If you don't intent to publish this app to the CLAMS app-directory, please use a full IRI format. 
